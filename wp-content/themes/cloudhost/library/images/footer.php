		...
		<h3 style="margin-top:8px; font-weight:300;"></h3>
                ...
                <div class="col-sm-1">
                    <div class="social">
                      <div class="social-icon"><a href="#"><i class="fa icon-twitter"></i></a></div>
                    </div>
                </div><!--/1-->
                                <div class="col-sm-1">
                    <div class="social">
                      <div class="social-icon"><a href="#"><i class="icon-facebook"></i></a></div>
                    </div>
                </div><!--/1-->		
                                <div class="col-sm-1">
                    <div class="social">
                      <div class="social-icon"><a href="#"><i class="icon-google-plus"></i></a></div>
                    </div>
                </div><!--/1-->		
                                <div class="col-sm-1">
                    <div class="social">
                      <div class="social-icon"><a href="#"><i class="icon-linkedin"></i></a></div>
                    </div>
                </div><!--/1-->					
		</div>
		</div>
		...
		<div class="col-md-2">
		<a href="#">Back to Top <i class="icon-arrow-up"></i></a>	
		</div>			
		</div>
		</div>
		</div>
